...
if(isset($_POST['submit']))  
   {
    ...
    if($Parent=='0')
    {
        $sql = "Update doc_groups set group_name = '$Name',
        parent = null where group_ID = '$ID' ";
        $res = mysqli_query($conn, $sql);
    }
    else
    {
        $sql = "Update doc_groups set group_name = '$Name',
        parent = '$Parent' where group_ID = '$ID' ";
        $res = mysqli_query($conn, $sql);
    }
    if($res==true)
   {
