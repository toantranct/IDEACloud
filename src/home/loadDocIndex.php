        ...
        <div class="col-lg-3 col-xl-2">
            <div class="file-man-box">
                ...
                <div class="file-img-box" style="font-size: 2rem;">
                    <a href="../home/index.php?type='.$type.'&id='.$row['parent'].'&parent='.$pr2.'"><i class="mdi mdi-keyboard-return"></i></a>
                </div>
        ...
        while ($row = $results->fetch_assoc()) {
            ...
            <div class="file-man-box">
                ...
                <div class="file-img-box" style="font-size: 4rem;">
                    <a href="../home/index.php?type='.$type.'&id='.$row['group_ID'].'&parent='.$row['parent'].'"><i class="mdi mdi-folder-multiple"></i></a>
                </div>
                <div class="file-man-title">
